...
survey_df<-read.csv("C:\Users\ayas\Desktop\SCMA 632\SCMA 632\assignments\A4\Survey.csv",header=TRUE) 
dim(survey_df) 
names(survey_df) 
head(survey_df) 
str(survey_df)
...
icecream_df <- read.csv("C://Users//ayas//Desktop//SCMA 632//SCMA 632//assignments//A4//icecream.csv", header = TRUE)
